...
describe('Given a Github Api URL for repositories tests', () => {
  describe(`When want to return the information of ${githubUserName}`, () => {
    let responseUser;
    ...
    it(`Then the info of ${githubUserName} should be retrieved`, () => {
    ...
    describe(`When want obtain the repository ${repository} from the user`, () => {
      ...
      it('Then the repository wanted should be in the list of the user"s repositories', () => {
      ...
      describe(`When want to download the repository ${repository}`, () => {
        ...
        describe(`When want to obtain the list of files and find the README.md of the repository ${repository}`, () => {
          ...
          it('Then the file README.md should be included in the list of files of the repository', () => {
